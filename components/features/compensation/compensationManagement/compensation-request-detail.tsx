...
const AllocationCard = ({
  ...
  <Card className="shadow-none rounded-[20px] min-w-[320px] max-w-[320px] flex-1 bg-white overflow-hidden flex flex-col justify-between">
    ...
    <div className="px-3 text-sm">
      <div className="px-4 mt-4 bg-[#F0F7FF] w-full flex justify-between items-center rounded-[6px]">
        <span className="text-subdude">คงเหลือ</span>
        <span className="font-normal text-[#18181B]">{balance}</span>
      </div>
    </div>
  </Card>
);
        ...
        <Card className="shadow-none rounded-[20px] bg-white p-6 mb-6">
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-3 mt-1">
              <Badge className="bg-[#FFF7ED] text-[#F97316] hover:bg-[#FFF7ED] border-none px-3 py-1 text-xs font-normal rounded-full flex items-center gap-1">
