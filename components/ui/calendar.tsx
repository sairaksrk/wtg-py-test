...
function Calendar({
	...
	const buttonRangeClassName
		= "bg-accent [&>button]:bg-black [&>button]:text-primary-foreground [&>button]:hover:bg-black [&>button]:hover:text-primary-foreground"
	...
	const _rangeMiddleClassName = cn(
		"bg-accent !text-foreground [&>button]:bg-transparent [&>button]:!text-black [&>button]:hover:bg-transparent [&>button]:hover:!text-black",
		props.rangeMiddleClassName,
	)
	const _selectedClassName = cn(
		"[&>button]:bg-blue-100 [&>button]:text-black-foreground [&>button]:hover:bg-blue-100 [&>button]:hover:text-black-foreground",
